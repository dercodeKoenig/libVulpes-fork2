...
public class ModuleContainerPanYOnly extends ModuleBase {
	...
	@Override
	@SideOnly(Side.CLIENT)
	public void renderToolTip(int guiOffsetX, int guiOffsetY, int mouseX, int mouseY, float zLevel,
							  GuiContainer gui, FontRenderer font) {
		for (ModuleBase module : moduleList)
			module.renderToolTip(guiOffsetX, guiOffsetY, mouseX, mouseY, zLevel, gui, font);
